...
def load_acm(ratio, type_num):
    ...
    return [feat_p, feat_a, feat_s], [pap, psp], label, train, val, test
...
def load_dblp(ratio, type_num):
    ...
    val = [th.LongTensor(i) for i in val]
    test = [th.LongTensor(i) for i in test]
    return [feat_a, feat_p], [apa, apcpa, aptpa], label, train, val, test
...
def load_aminer(ratio, type_num):
    ...
    val = [th.LongTensor(i) for i in val]
    test = [th.LongTensor(i) for i in test]
    return [feat_p, feat_a, feat_r], [pap, prp], label, train, val, test
...
def load_freebase(ratio, type_num):
    ...
    val = [th.LongTensor(i) for i in val]
    test = [th.LongTensor(i) for i in test]
    return [feat_m, feat_d, feat_a, feat_w], [mdm, mam, mwm], label, train, val, test
